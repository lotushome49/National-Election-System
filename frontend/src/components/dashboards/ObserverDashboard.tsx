...
export function ObserverDashboard({ setView, t, i18n, token }: any) {
  ...
  const incidents = [66, 52, 74, 41, 58];
  const evidence = [
    { label: "Photo", value: 82 },
    { label: "Video", value: 61 },
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-8">
        <div className="space-y-4">
          ...
          <p className="text-slate-400 text-sm font-medium leading-relaxed max-w-2xl uppercase tracking-widest">
            Active incident tracking and evidence intake for public observers.
          </p>
        </div>
