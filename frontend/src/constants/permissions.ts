...
export const HAS_PERMISSION = {
  ...
  MANAGE_VOTERS: ['SUPER_ADMIN', 'ADMIN', 'REGIONAL_ADMIN', 'DISTRICT_ADMIN', 'STAFF'],
  CAST_VOTE: ['VOTER'],
  VIEW_RESULTS: ['SUPER_ADMIN', 'ADMIN', 'REGIONAL_ADMIN', 'DISTRICT_ADMIN', 'STAFF', 'OBSERVER'],
  MANAGE_REGIONS: ['SUPER_ADMIN', 'ADMIN'],
  MANAGE_DISTRICTS: ['SUPER_ADMIN', 'ADMIN', 'REGIONAL_ADMIN'],
  MANAGE_POLLING_STATIONS: ['SUPER_ADMIN', 'ADMIN', 'REGIONAL_ADMIN', 'DISTRICT_ADMIN'],
